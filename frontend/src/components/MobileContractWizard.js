...
const MobileContractWizard = ({ 
  ...
  // Optimized input focus handlers - prevent re-renders
  ...
  const handleInputBlur = useCallback((fieldName) => {
    if (activeInputRef.current === fieldName) {
  ...
  // Optimized updateStepData with better state management
  const updateStepData = useCallback((step, field, value) => {
    setStepData(prevStepData => {
      // Only update if the value has actually changed
      if (prevStepData[step][field] === value) {
        return prevStepData;
      }
      ...
      <Card className="border-l-4 border-l-blue-500">
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <StableInput
              inputRef={(el) => inputRefs.current['party1_name'] = el}
              id="party1_name"
              value={stepData.step2.party1_name}
              onChange={changeHandlers.party1_name}
          ...
          <div>
            ...
            <StableInput
              inputRef={(el) => inputRefs.current['party1_email'] = el}
              id="party1_email"
              type="email"
              value={stepData.step2.party1_email}
              onChange={changeHandlers.party1_email}
          ...
          <div>
            ...
            <StableTextarea
              inputRef={(el) => inputRefs.current['party1_address'] = el}
              id="party1_address"
              value={stepData.step2.party1_address}
              onChange={changeHandlers.party1_address}
              onFocus={() => handleInputFocus('party1_address')}
              onBlur={() => handleInputBlur('party1_address')}
      ...
      <Card className="border-l-4 border-l-green-500">
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <StableInput
              inputRef={(el) => inputRefs.current['party2_name'] = el}
              id="party2_name"
              value={stepData.step2.party2_name}
              onChange={changeHandlers.party2_name}
              onFocus={() => handleInputFocus('party2_name')}
              onBlur={() => handleInputBlur('party2_name')}
          ...
          <div>
            ...
            <StableInput
              inputRef={(el) => inputRefs.current['party2_email'] = el}
              id="party2_email"
              type="email"
              value={stepData.step2.party2_email}
              onChange={changeHandlers.party2_email}
              onFocus={() => handleInputFocus('party2_email')}
              onBlur={() => handleInputBlur('party2_email')}
          ...
          <div>
            ...
            <StableInput
              inputRef={(el) => inputRefs.current['party2_phone'] = el}
              id="party2_phone"
              type="tel"
              value={stepData.step2.party2_phone}
              onChange={changeHandlers.party2_phone}
    ...
    <div className="space-y-6 p-4">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <StableTextarea
            inputRef={(el) => inputRefs.current['deliverables'] = el}
            id="deliverables"
            value={stepData.step3.deliverables}
            onChange={changeHandlers.deliverables}
